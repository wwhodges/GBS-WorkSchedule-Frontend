...
export const fieldSettings: IFieldSettings[] = [
    ...
    { name: 'prime', edit: false, type: 'text', desc: 'Prime', size: '1', style: '', options: [] },
];
...
export const defaultScheduledFields: IFieldSettings[] = [
    ...
    { name: 'holdLoc', edit: true, type: 'text', desc: 'Holding', size: '10', style: '', options: [] },
    { name: 'palDest', edit: false, type: 'text', desc: 'Destination', size: '8', style: '', options: [] },
    { name: 'workDate', edit: false, type: 'date', desc: 'Work Date', size: '10', style: 'width: 130px;', options: [] },
    { name: 'delDate', edit: false, type: 'date', desc: 'Deliver Date', size: '10', style: 'width: 130px;', options: [] },
    { name: 'despDate', edit: false, type: 'date', desc: 'Despatch Date', size: '10', style: 'width: 130px;', options: [] },
];
